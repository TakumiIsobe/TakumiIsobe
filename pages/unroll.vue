	...
	<main>
		...
		<div data-scroll>
			...
			<section class="section intro">
				<div class="intro__wrap">
					<div class="intro__background-image">
						<img src="~/assets/image/unroll/intro1.jpg" alt="Some image">
						<div class="intro__title">Watson Building, Dubai, 2020</div>
					</div>
					<div class="intro__foreground-image">
						<img src="~/assets/image/unroll/intro2.jpg" class="js-image" alt="Some image">
					</div>
				</div>
			</section>
			<!-- end section -->
			...
			<section class="section dos">
				<div class="dos__foreground">
					...
					<div class="dos__foreground-image">
						<img src="~/assets/image/unroll/dos1.jpg" alt="Some image">
					</div>
				</div>
				<div class="dos__background">
					<div class="dos__background-image">
						<img src="~/assets/image/unroll/dos2.jpg" class="js-image" alt="Some image">
					</div>
					<div class="dos__text">
			...
			<section class="section tres">
				<div class="tres__foreground">
					<div class="tres__foreground-image">
						<img src="~/assets/image/unroll/tres1.jpg" class="js-image" alt="Some image">
					</div>
					<div class="meta">
				...
				<div class="tres__background">
					<div class="tres__background-image">
						<img src="~/assets/image/unroll/tres2.jpg" alt="Some image">
					</div>
			...
			<section class="section cuatro">
				<ul>
					<li><img src="~/assets/image/unroll/1.jpg" class="js-image" alt="Some image"></li>
					<li><img src="~/assets/image/unroll/2.jpg" class="js-image" alt="Some image"></li>
					<li><img src="~/assets/image/unroll/3.jpg" class="js-image" alt="Some image"></li>
					<li><img src="~/assets/image/unroll/4.jpg" class="js-image" alt="Some image"></li>
				</ul>
			</section>
			<!-- end section -->
			<!-- begin section -->
			<section class="section last">
				...
				<div class="last__image">
					<img src="~/assets/image/unroll/last.jpg" class="js-image" alt="Some image">
				</div>
            </section>
			<!-- end section -->
		</div>
...
<script>
//import Scene from "@/js/rolls.js";
export default {
    head: {
        title: 'Unroll Effects',
        bodyAttrs: {class: 'loading'},
        script: [
            { src: 'js/imagesLoaded.js', body: true },
            { src: 'js/rolls.js', body: true },
            { src: 'js/app.js', body: true, module: true }
        ],
    },
    plugins: [
         '@/plugins/unroll-plugin'
    ]
}
</script>
